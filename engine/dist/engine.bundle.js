...
class Engine {
    ...
    negamax(depth, turnColour, alpha = -Infinity, beta = Infinity) {
        ...
        // if (moves.length === 0) {
        //   if (this.kingIsInCheck(turnColour)) {
        //     // return a mate score adjusted for depth
        //     const mateScore = turnColour === TURN.WHITE ? EG_PIECE_VALUES[PIECE.KING] - depth : EG_PIECE_VALUES[PIECE.KING] + depth;
        //     return { score: mateScore, bestMove: 0 };
        //   }
        // }
...
const fen = 'r1bq1r1k/p5b1/2pp2Q1/4p3/2B5/P1PP3P/1P4P1/R6K w - - 0 21';
const engine = new ChessEngineAPI(fen);
console.log(engine.getBestMove(1));
