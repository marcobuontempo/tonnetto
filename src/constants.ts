...
export const MOVE_LIST: Array<Int8Array> = [
...
export const SLIDERS: Array<boolean> = [
  /* black pawn */ false,
  /* white pawn */ false,
  /*     knight */ false,
  /*     bishop */ true,
...
export const BOARD_STATES = {
  EMPTY:                    0b0000_0000_0000_0000_0000_0000_0000_0000,
  HALFMOVE_CLOCK:           0b0000_0000_0000_0000_0000_0000_1111_1111,
...
export const MG_PIECE_VALUES = new Uint16Array([
  0,      // none
  82,     // pawn
  337,    // knight
  365,    // bishop
...
export const EG_PIECE_VALUES = new Uint16Array([
  0,      // none
  94,     // pawn
  281,    // knight
  297,    // bishop
...
// middle-game values
export const MG_PIECE_SQUARE_TABLE: Array<Int16Array> = [
  // no piece = 0
  new Int16Array([]),
...
// end-game values
export const EG_PIECE_SQUARE_TABLE: Array<Int16Array> = [
  // no piece = 0
  new Int16Array([]),
...
export const FLIP = new Uint8Array([
...
export const GAME_PHASE = new Uint8Array([ 0, 0, 1, 1, 2, 4, 0] );  // used as weights to calculate how 'influential' a piece move is towards reaching endgame [n/a, pawn, knight, bishop, etc...]