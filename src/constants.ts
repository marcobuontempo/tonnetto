...
// Base amount that pieces are worth
export const PIECE_WORTH_VALUES= {
  [PIECE.PAWN]:   1,
  [PIECE.KNIGHT]: 3,
  [PIECE.BISHOP]: 3,
  [PIECE.ROOK]:   5,
...
export const PIECE_EVAL_VALUES = {
  [PIECE.PAWN | PIECE.IS_WHITE]:    PIECE_WORTH_VALUES[PIECE.PAWN],
  [PIECE.KNIGHT | PIECE.IS_WHITE]:  PIECE_WORTH_VALUES[PIECE.KNIGHT],
  [PIECE.BISHOP | PIECE.IS_WHITE]:  PIECE_WORTH_VALUES[PIECE.BISHOP],
  [PIECE.ROOK | PIECE.IS_WHITE]:    PIECE_WORTH_VALUES[PIECE.ROOK],
  [PIECE.QUEEN | PIECE.IS_WHITE]:   PIECE_WORTH_VALUES[PIECE.QUEEN],
  [PIECE.KING | PIECE.IS_WHITE]:    PIECE_WORTH_VALUES[PIECE.KING],
  [PIECE.PAWN | PIECE.IS_BLACK]:   -PIECE_WORTH_VALUES[PIECE.PAWN],
  [PIECE.KNIGHT | PIECE.IS_BLACK]: -PIECE_WORTH_VALUES[PIECE.KNIGHT],
  [PIECE.BISHOP | PIECE.IS_BLACK]: -PIECE_WORTH_VALUES[PIECE.BISHOP],
  [PIECE.ROOK | PIECE.IS_BLACK]:   -PIECE_WORTH_VALUES[PIECE.ROOK],
  [PIECE.QUEEN | PIECE.IS_BLACK]:  -PIECE_WORTH_VALUES[PIECE.QUEEN],
  [PIECE.KING | PIECE.IS_BLACK]:   -PIECE_WORTH_VALUES[PIECE.KING],
}